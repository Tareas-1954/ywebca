...
Exer.keywords1 = function ( dogs, two ) {
  var animales = 2;
  var zapatos = two+2;
  dogs += "2";
  var mama = animales + zapatos + dogs + two;
  return mama;
};
...
Exer.return4 = function () {
  ...
  // your work goes here
console.log(""+ magicFunc("manzanas")+magicFunc("naranjas"));
};
...
Exer.return5 = function () {
  ...
  var dinero=strShift("abcABC123!@#");
  // Declare and initialize a variable for the second string.
var zapatos=strShift(strShift("a S d F j K l"));
  // A return statement.
return strShuffle(dinero,zapatos);
};
...
var respuesta = prompt("What is the answer to the meaning of life, the universe, and everything?")
return respuesta;
};
...
var carros = confirm("Imma let you finish, but Javascript is one of the best programming languages of all time...one of the best programming languages of all time!");
...
Exer.condition4 = function () {
  ...
  // Prompt the user
var fecha=Number(prompt("Enter today's date, please."));
  ...
  // Otherwise...
    ...
    else if (fecha>=29 && fecha<=31) {
      console.log("I sure hope it isn't February.");
    }
    // Otherwise...
    else{
      console.log("Did you know? There are exactly "+fecha+" ways to make today awesome!")
    }
